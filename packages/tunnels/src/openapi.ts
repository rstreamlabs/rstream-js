...
export const engineOpenApiDocument = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "Operational data-plane API exposed by rstream-engine. This surface is scoped to the authenticated engine or project endpoint and covers live clients, live tunnels, and state-change streams.",
  },
  servers: [
    {
      url: "https://{engine}",
